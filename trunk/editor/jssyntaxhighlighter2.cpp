#include "jssyntaxhighlighter2.h"
...
JsSyntaxHighlighter2::JsSyntaxHighlighter2(QTextDocument *document)
...
JsSyntaxHighlighter2::~JsSyntaxHighlighter2()
{
}

void JsSyntaxHighlighter2::highlightBlock(const QString &text)
{
...
void JsSyntaxHighlighter2::highlightWord(int currentPos, const QString &buffer)
{
    if (buffer.isEmpty())
        return;
